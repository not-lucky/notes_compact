...
**Difficulty:** Hard
**Concept:** Directed variation (refer to cycle-detection-directed)

```python
# See solutions/08-graphs/05-cycle-detection-directed.md for implementation
```
