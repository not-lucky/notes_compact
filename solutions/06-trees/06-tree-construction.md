...
1.  **BST Property**: In a BST, the inorder traversal is automatically sorted. While we _could_ sort the preorder array to get inorder and then use the "Preorder + Inorder" algorithm ($O(n \log n)$), we can do better.
