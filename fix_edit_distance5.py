...
# I want to add `functools.cache` or `lru_cache` to the `dfs` function in the memoization approach.
# It uses a manual `memo = {}` dict. Let's make it cleaner and more Pythonic.
...
# Also the delete operations memoization
